#!pip install prophet yfinance matplotlib pandas streamlit
...
tickers = ('CL=F', 'NVDA', 'COIN', 'AMZN', 'AMGN', 'AAPL', 'BA', 'CAT', 'CSCO', 'CVX', 'GS',	'HD', 'HON', 'IBM', 'INTC', 'JNJ', 'KO', 'JPM', 'MCD', 'MMM', 'MRK', 'MSFT', 'NKE', 'PG', 'TRV', 'UNH','CRM', 'VZ', 'V', 'WBA', 'WMT', 'DIS', 'DOW')
...
# df = ticker.history(start=start, end=end, max_age=dt.timedelta(hours=1)).Close
